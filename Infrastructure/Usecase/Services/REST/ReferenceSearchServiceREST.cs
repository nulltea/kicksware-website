...
{
	public class ReferenceSearchServiceREST : IReferenceSearchService
	{
		private readonly IGatewayClient<IGatewayRestRequest> _client;

		public ReferenceSearchServiceREST(IGatewayClient<IGatewayRestRequest> client) => _client = client;
